...
import { Coins, Trophy, XCircle, Percent, Flame } from 'lucide-react';
...
export const CoinFlipHeader: React.FC<CoinFlipHeaderProps> = ({ stats }) => {
  const winRatio =
  ...
  return (
    <div className="w-full flex items-center justify-between mb-8 border-b border-zinc-800/60 pb-5">
      <div className="flex items-center gap-2">
        ...
        <h2 className="text-lg font-bold tracking-wide text-zinc-300">COIN FLIP CONSOLE</h2>
      </div>
